...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("quality", "Use the 16-step QUALITY preset for the next local image", "Configuration",
               gateway_only=True, args_hint="[image prompt]"),
    CommandDef("literal", "Skip prompt enrichment for the next local image", "Configuration",
               gateway_only=True, args_hint="[image prompt]"),
